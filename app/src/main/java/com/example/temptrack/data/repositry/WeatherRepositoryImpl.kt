...
class WeatherRepositoryImpl private constructor(var remoteDataSource: WeatherRemoteDataSource, var localDataSource: FavoriteLocalDataSource) :
    WeatherRepository {
  ...
  fun getInstance(remoteDataSource: WeatherRemoteDataSource, localDataSource: FavoriteLocalDataSource): WeatherRepositoryImpl {
